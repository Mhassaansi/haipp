...
class AppBlockerAdapter(
    ...
    RecyclerView.Adapter<AppBlockerAdapter.ViewHolder>() {
        ...
        holder.Switchimg.setOnClickListener {
            ...
            if(!holder.Switchimg.isChecked){
                ...
                if(AppBlockerFragment.not_detail != null){
                    AppBlockerFragment.not_detail!!.sendmessage(position,
                        item.get("pacakagename").toString(),appBlockerArrayList!!,"true",item["pacakagename"].toString(),item["appname"].toString())
                ...
                if(AppBlockerFragment.not_detail != null){
                    AppBlockerFragment.not_detail!!.sendmessage(position,
                        item.get("pacakagename").toString(),appBlockerArrayList!!,"false",item["pacakagename"].toString(),item["appname"].toString())
