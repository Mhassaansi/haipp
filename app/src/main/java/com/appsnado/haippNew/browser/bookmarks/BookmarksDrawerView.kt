package com.appsnado.haippNew.browser.bookmarks

import com.appsnado.haippNew.adblock.allowlist.AllowListModel
import com.appsnado.haippNew.animation.AnimationUtils
import com.appsnado.haippNew.browser.BookmarksView
import com.appsnado.haippNew.browser.TabsManager
...
import com.appsnado.haippNew.di.NetworkScheduler
...
import com.appsnado.haippNew.extensions.color
import com.appsnado.haippNew.extensions.drawable
import com.appsnado.haippNew.extensions.inflater
import com.appsnado.haippNew.favicon.FaviconModel
import com.appsnado.haippNew.utils.isSpecialUrl
...
class BookmarksDrawerView @JvmOverloads constructor(
    ...
    @Inject
    internal lateinit var allowListModel: AllowListModel
    ...
    private fun handleItemClick(bookmark: Bookmark) = when (bookmark) {
        is Bookmark.Folder -> {
            scrollIndex =
                (bookmarkRecyclerView?.layoutManager as LinearLayoutManager).findFirstVisibleItemPosition()
