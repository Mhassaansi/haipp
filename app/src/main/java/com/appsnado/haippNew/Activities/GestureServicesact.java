...
import com.appsnado.haippNew.Applocakpacakges.utils.StatusBarUtil;
...
import com.appsnado.haippNew.Applocakpacakges.widget.UnLockMenuPopWindow;
...
public class GestureServicesact extends BaseActivity implements View.OnClickListener {
    ...
    private GestReceiver mGestureUnlockReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGestureUnlockReceiver = new GestReceiver();
                ...
                mUnLockLayout.getViewTreeObserver().addOnPreDrawListener(
                        new ViewTreeObserver.OnPreDrawListener() {
                            ...
                            public boolean onPreDraw() {
                                ...
                                try {
                                    LockUtil.blur(GestureServicesact.this, LockUtil.big(bmp), mUnLockLayout, width, height);
            ...
            public void onPatternDetected(@NonNull List<LockPatternView.Cell> pattern) {
                if (mLockPatternUtils.checkPattern(pattern)) { //
                    ...
                    if (actionFrom.equals(AppConstants.LOCK_FROM_LOCK_MAIN_ACITVITY)) {
                        startActivity(new Intent(GestureServicesact.this, MainActivity.class));
                        finish();
                    } else {
    ...
    protected void initAction() {
        ...
        private class GestReceiver extends BroadcastReceiver {
