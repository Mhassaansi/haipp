...
class MainViewModel(services: WebServiceFactory, activity: Activity?) : BaseViewModel<Any>() {
    ...
    fun loadDataNetwork(userid: String?) {
        setIsLoading(true)
        webservices!!.getservices()!!.logout(userid)!!.enqueue(ResponcesCallback())
    }
