...
import com.appsnado.haippNew.Applocakpacakges.model.FaviterInfo;
...
public class LoadAppListService extends IntentService {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtil.createNotification(this,"Haipp Lock","Haipp lock Services running in background");
        }
    }
