package com.appsnado.haippNew.Applocakpacakges.utils;
...
public class NotificationUtil {
    ...
    public static void createNotification(Service mContext, String title, String message) {
        ...
        NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "Haipp lock background task ", importance);
