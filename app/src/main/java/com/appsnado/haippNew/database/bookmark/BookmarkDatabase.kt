package com.appsnado.haippNew.database.bookmark

import com.appsnado.haippNew.database.Bookmark
import com.appsnado.haippNew.database.asFolder
import com.appsnado.haippNew.database.databaseDelegate
import com.appsnado.haippNew.extensions.firstOrNullMap
import com.appsnado.haippNew.extensions.useMap
...
class BookmarkDatabase @Inject constructor(
    ...
    private val defaultBookmarkTitle: String = application.getString(com.appsnado.haippNew.R.string.untitled)
